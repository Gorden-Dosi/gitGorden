describe('scope 대해서 학습합니다.', function () {
  ...
  it('lexical scope에 대해서 확인합니다.', function () {
    ...
    function shadowGlobal2(message) { //매개변수도 스코프에 포함
      return message;
    }

    function shadowParameter(message) {
      message = 'Do not use parameters like this!'; //파라미터 === 매개변수에 할당하지 마세요. 문제 시 확인 불가
      return message;
    } // readability* 
  ...
  it('lexical scope와 closure에 대해 다시 확인합니다.', function () {
    ...
    const innerFn = outerFn(); // 작동하지 않음 추후 디버거 사용해야 함
